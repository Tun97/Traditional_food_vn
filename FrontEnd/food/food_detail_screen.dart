              ...
              child: Wrap(
                ...
                children: [
                  ...
                  _StatTile(
                    ...
                    label: 'Video',
                    value: food.videoUrl.trim().isNotEmpty
                        ? 'Sẵn sàng'
                        : 'Chưa có',
          ...
          ClipRRect(
            ...
            child: SizedBox(
              ...
              child: food.imageUrl.trim().isEmpty
                  ? _HeroImageFallback(food: food, accentColor: accentColor)
                  : Image.network(
                      food.imageUrl,
                      fit: BoxFit.cover,
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  food.description.isEmpty
                      ? 'Khám phá món ăn truyền thống Việt Nam với phần hướng dẫn trực quan hơn.'
                      : food.description,
                  maxLines: 3,
